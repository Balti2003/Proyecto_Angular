import { CustomInputComponent, CustomSelectComponent } from '@/app/components';
...
@Component({
  selector: 'app-character-add-edit.component',
  standalone: true,
...
export class CharacterAddEditComponent {
  ...
  characterToEdit = computed(() => this.characterService.getCharactersById(Number(this.id())) ?? EmptyCharacter);
